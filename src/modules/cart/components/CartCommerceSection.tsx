...
export default function CartCommerceSection({ commerce, onRemove, onQuantityChange }: Props) {
  return (
    <>
      ...
      <CustomTitle text={commerce.commerceName} color="#2d2d2d" variant="h5" align="left" />
      <Box sx={{ mb: 2 }}>
        <CommerceInfoCard
